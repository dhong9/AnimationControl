...
Angles joint_angles[num_targets] = {
	...
	Angles(Vector3D(0.0f, 3 * HALF_PI, 0.0f), Vector3D(0.0f, 0.0f, 0.0f)),
	Angles(Vector3D(-HALF_PI, 0.0f, 0.0f), Vector3D(0.0f, 0.0f, 0.0f)),
	Angles(Vector3D(HALF_PI, 0.0f, 0.0f), Vector3D(0.0f, 0.0f, 0.0f)),
	Angles(Vector3D(-HALF_PI, 0.0f, 0.0f), Vector3D(HALF_PI, 0.0f, 0.0f)),
	Angles(Vector3D(0.0f, HALF_PI, 0.0f), Vector3D(0.0f, HALF_PI, 0.0f)),
	Angles(Vector3D(0.0f, -HALF_PI, 0.0f), Vector3D(-HALF_PI, 0.0f, 0.0f)),
	Angles(Vector3D(0.0f, 0.0f, 0.0f), Vector3D(HALF_PI, 0.0f, 0.0f)),
	Angles(Vector3D(-HALF_PI / 2.0f, 0.0f, 0.0f), Vector3D(0.0f, 0.0f, 0.0f)),
	Angles(Vector3D(-HALF_PI / 2.0f, 0.0f, 0.0f), Vector3D(HALF_PI / 2.0f, 0.0f, 0.0f)),
	Angles(Vector3D(0.0f, -HALF_PI / 2.0f, 0.0f), Vector3D(0.0f, HALF_PI / 2.0f, 0.0f)),
	Angles(Vector3D(HALF_PI, 0.0f, 0.0f), Vector3D(PI, 0.0f, 0.0f)),
	Angles(Vector3D(HALF_PI / 2.0f, 0.0f, 0.0f), Vector3D(HALF_PI, 0.0f, 0.0f)),
	Angles(Vector3D(HALF_PI / 2.0f, PI, 0.0f), Vector3D(-HALF_PI / 2.0f, 0.0f, 0.0f))
};
